#!/usr/bin/env bash
# Variant branch goal-image-language-early: the `image_language-early` condition of the two-task conditioning smoke matrix, trained by this
...
export DP_CONDITION=image_language-early DP_CHECKOUT="$HERE"
